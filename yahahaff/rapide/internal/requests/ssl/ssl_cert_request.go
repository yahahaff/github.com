...
type SSLCertCreateRequest struct {
	...
	CommonName       string `json:"commonName" binding:"required,max=255"`
	...
	Provider         string `json:"provider" binding:"required,oneof=letsencrypt google"`
	ChallengeType    string `json:"challengeType" binding:"required,oneof=http-01 dns-01"`
